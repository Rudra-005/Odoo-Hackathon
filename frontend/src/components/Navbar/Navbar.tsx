    ...
    <>
      <header className="h-[70px] bg-white dark:bg-dark-surface border-b border-light-border dark:border-dark-border px-8 flex items-center justify-between shrink-0 sticky top-0 z-20">
        <div className="flex items-center flex-1 gap-8">
          ...
          {/* Global Search */}
          <div 
            className="hidden md:flex relative max-w-md w-full cursor-text"
          ...
          >
            ...
            <input 
              ...
              className="w-full bg-slate-100 dark:bg-slate-800 border-transparent rounded-xl pl-10 pr-4 py-2 text-sm text-slate-500 placeholder-slate-400 cursor-text focus:outline-none hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors"
            />
